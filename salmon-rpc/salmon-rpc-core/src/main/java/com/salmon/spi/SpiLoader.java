...
public class SpiLoader {
     ...
     * 存储已加载的类：接口名 =>（key => 实现类）
     */
    private static Map<String, Map<String, Class<?>>> LOADER_MAP = new ConcurrentHashMap<>();

    /**
     * 对象实例缓存（避免重复 new），类路径 => 对象实例，单例模式
     */
    private static Map<String, Object> INSTANCE_CACHE = new ConcurrentHashMap<>();
                ...
                try {
                    ...
                    while ((line = bufferedReader.readLine()) != null) {
                        ...
                        if (strArray.length > 1) {
                            ...
                            // 实现类全路径名称 如：com.salmon.serializer.JdkSerializer
